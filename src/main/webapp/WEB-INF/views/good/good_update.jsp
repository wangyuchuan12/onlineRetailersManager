							...
							<form role="form"
								...
								<div class="form-group" name="statusDiv">
									...
									<div>
										...
										<div style="display: inline-block;"><input <c:if test="${good.status==2}">checked="checked"</c:if>class="form-control" type="radio" name="status" style="width:20px;display: inline-block;" value="2"><label style="font-size: 10px;line-height: -20px;display: inline-block;text-align: justify;">售完</label></div>
