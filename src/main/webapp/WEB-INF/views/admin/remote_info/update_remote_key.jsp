	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">修改遥控器按键</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form"
								action="<c:url value="/remote_info/key_update_do?id=${remoteKey.id}"/>" method="post"
								onsubmit="return addSubmit();">
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>id</label> <input class="form-control" type="text" name="id" disabled="disabled" value="${remoteKey.id}">
									<p class="help-block">遥控器类型id</p>
								</div>
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>按键名称</label> <input class="form-control" type="text" name="display_name" value="${remoteKey.displayName}">
									<p class="help-block">数据格式,主要用于显示，可用中文表示</p>
								</div>
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>key</label> <input class="form-control" type="text" name="name" value="${remoteKey.name}">
