...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel-heading">遥控器编码格式管理</div>
                <div class="panel-body">
                    ...
                    <div class="dataTable_wrapper">
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length">
                                	...
                                	<label><button type="button" class="btn btn-info" onclick="javascript:window.location.href='<c:url value="/remote_info/codec_add_view" />'" >新增</button></label>
                                    ...
                                    <thead>
                                        <tr role="row">
                                        	...
                                        	<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 331px;">编码格式</th>
                                    ...
                                    <tbody>
                                    <c:forEach items="${remoteCodecs}" var="remoteCodec" varStatus="">
                                    	<tr class="gradeA odd" role="row">
                                            <td class="sorting_1">${remoteCodec.id}</td>
                                            <td>${remoteCodec.displayName}</td>
                                            <td>${remoteCodec.name}</td>
                                            <td class="center">
                                            	<a href="<c:url value="/remote_info/codec_update_view?id=${remoteCodec.id}"/>">修改</a>
									<a href="<c:url value="/remote_info/codec_del_do?id=${remoteCodec.id}" />">删除</a>
