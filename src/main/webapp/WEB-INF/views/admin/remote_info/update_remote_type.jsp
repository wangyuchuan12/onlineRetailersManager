			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form"
								action="<c:url value="/remote_info/type_update_do?id=${remoteType.id}"/>" method="post"
								onsubmit="return addSubmit();">
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>id</label> <input class="form-control" type="text" name="id" disabled="disabled" value="${remoteType.id}">
									<p class="help-block">遥控器类型id</p>
								</div>
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>数据类型</label> <input class="form-control" type="text" name="display_name" value="${remoteType.displayName}">
									<p class="help-block">数据类型,主要用于显示，可用中文表示</p>
								</div>
								<div class="form-group" name="affirm_passwordDiv" id="device_name_div">
									<label>key</label> <input class="form-control" type="text" name="name" value="${remoteType.name}">
